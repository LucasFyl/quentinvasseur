...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body> 
       ...
       <div id="content">
            <h1 style="text-align:center;padding-left: 0;">quentin&nbsp;vasseur</h1>
            <nav>
                <ul>
                    <li class="direct"><a href="../about">about</a></li>
                    <li><a href="#" class="dropdown">collections</a>
                        <ul class="dropdown-menu">
                            <?php foreach($pages->find('collections')->children()->visible() as $wo): ?>
                    ...
                    <li><a href="#" class="dropdown">illustrations</a>
                        <ul class="dropdown-menu">
                            <?php foreach($pages->find('illustrations')->children()->visible() as $wo): ?>
                                <li class="direct"><a href="<?php echo $wo->url() ?>"><?php echo html($wo->title()); ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                    <li><a href="#" class="dropdown-sneaker">sneakers</a>
                        <ul class="dropdown-menu" >
                            <?php foreach($pages->find('sneakers')->children()->visible() as $wo): ?>
                                <li class="direct"><a href="<?php echo $wo->url() ?>"><?php echo html($wo->title()); ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
